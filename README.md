...
gantt
    title 🗺️ Дорожная карта разработки "Сапевари"
    dateFormat  YYYY-MM-DD
    axisFormat %b %Y
    tickInterval 1month
    
    section 📋 Подготовительный этап
    Исследование рынка & анализ :done, research, 2024-01-01, 21d
    Техническое проектирование :done, design, after research, 14d
    Дизайн-система & UI/UX :active, design_system, after design, 21d
    
    section ⚙️ Бэкенд разработка
    База данных & API ядро :backend_core, 2024-02-26, 28d
    Модуль рецептов :recipe_module, after backend_core, 21d
    Модуль пользователей :user_module, after backend_core, 21d
    Конструктор меню :menu_builder, after recipe_module, 28d
    Поиск & рекомендации :search_engine, after menu_builder, 21d
    
    section 🎨 Фронтенд разработка
    Базовые компоненты :frontend_core, 2024-02-26, 21d
    Страницы рецептов :recipe_ui, after frontend_core, 21d
    Личный кабинет :user_ui, after frontend_core, 21d
    Конструктор интерфейс :menu_ui, after menu_builder, 21d
    Адаптивный дизайн :responsive, after menu_ui, 14d
    
    section 🔄 Интеграция
    Соединение API :integration, 2024-05-20, 21d
    Функциональное тестирование :testing, after integration, 21d
    Юзабилити-тестирование :usability, after testing, 14d
    Оптимизация :optimization, after usability, 14d
    
    section 🚀 Запуск
    Бета-тестирование :beta, 2024-07-29, 21d
    Подготовка к релизу :release_prep, after beta, 14d
    Официальный запуск :milestone, launch, 2024-08-26, 1d
    Сбор фидбека :feedback, after launch, 30d
